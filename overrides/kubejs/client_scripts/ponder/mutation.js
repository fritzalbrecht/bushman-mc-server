...
// Ponder.tags((event) => {
//   event
//     .createTag('kubejs:mutation', "productivebees:advanced_oak_beehive", "Mutating Bees", "Test", [
...
//   event
//     .create(Item.of("productivebees:advanced_oak_beehive"))
//     .scene(
//       'pollen_mechanics',
//       'Bee Pollen - Practically Dripping with Function',
//       'kubejs:kubejs/bases/3x3',
//       (scene, util) => {
...
//         scene.world.setBlock([1, 1, 1], util.getDefaultState('minecraft:iron_ore'), true);
...
//         scene.world.destroyBlock([1, 1, 1]);
//         scene.idle(1);
//         var spawnEgg = scene.world.createItemEntity([1, 1.5, 1], [0, 0, 0], Item.of('resourcefulbees:steel_bee_spawn_egg'));
...
//       'kubejs:resourcefulbees/mutation/mutation_chamber',
//       (scene, util) => {
//         scene.showBasePlate();
